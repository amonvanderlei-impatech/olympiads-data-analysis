...
Para adicionar o nome dos países em português, vamos usar uma tabela de converção segundo os padrões do COI. A tabela foi elaborada por mim com dados disponíveis online em: <https://pt.wikipedia.org/wiki/Lista_de_pa%C3%ADses_por_c%C3%B3digo_do_COI>.

```{r}
# Traduções por Sigla
siglas_convercao <- read.csv("siglas_grupos_coi.csv")
